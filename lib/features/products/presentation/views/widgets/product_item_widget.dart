...
import 'package:market_app_web_2/features/products/presentation/views/add_edit_product_screen.dart';
    ...
    return InkWell(
      onTap: () {
        Navigator.of(context)
            .pushNamed(AddEditProductScreen.routeName, arguments: productModel);
      },
      child: Container(
